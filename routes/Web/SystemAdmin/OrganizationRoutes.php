...
use App\Http\Controllers\Web\SystemAdmin\Organization\Location\DisplayLocationsViewController;
use App\Http\Controllers\Web\SystemAdmin\Organization\Location\ProcessCreateLocationController;
...
Route::group(['middleware' => ['auth:system-admin']], function () {
    ...
    Route::group(['prefix' => 'location'], function () {
        Route::post('/{organizationId}/process/create/location', ProcessCreateLocationController::class)->name('web.system-admin.organization.location.process-create-location');
        Route::get('/{organizationId}', DisplayLocationsViewController::class)->name('web.system-admin.organization.location.display-locations-view');
    });
