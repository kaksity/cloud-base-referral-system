...
export default function WardTable({
    ...
    wards: ExtendWard[];
    onEditWardClicked: (localGovernmentArea: ExtendWard) => void;
    ...
    const columns: ColumnDef<ExtendWard>[] = React.useMemo(
        () => [
            {
            ...
            {
                accessorKey: 'local_government_area.name',
                header: () => <span className="text-sm font-semibold">State Name</span>,
                cell: ({ row }) => {
                    const name = row.original.local_government_area.name;
                    return <span className="font-medium text-gray-800">{name}</span>;
                },
            },
            {
                accessorKey: 'name',
                header: () => <span className="text-sm font-semibold">Ward Name</span>,
                cell: ({ row }) => {
                    ...
                    return (
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                                ...
                                <DropdownMenuSeparator />
                                <DropdownMenuItem onClick={() => onEditWardClicked(state)}>Edit</DropdownMenuItem>
                            ...
                            <TableRow className="hover:bg-transparent data-[state=selected]:bg-transparent">
                                <TableCell colSpan={columns.length} className="h-48">
                                    <EmptyState
                                        ...
                                        description="Your wards will show up here as soon as a ward is created."
                                    />
                                </TableCell>
                            </TableRow>
                        )}
