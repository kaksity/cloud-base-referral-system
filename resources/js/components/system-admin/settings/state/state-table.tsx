import ProcessDeleteStateController from '@/actions/App/Http/Controllers/Web/SystemAdmin/Settings/State/ProcessDeleteStateController';
...
export default function StateTable({
    ...
    onEditStateClicked: (state: ExtendedState) => void;
    paginationPayload: {
        meta: PaginationMeta;
    ...
    function deleteState(stateId: string) {
        form.delete(ProcessDeleteStateController.url({ stateId }), {
            onSuccess: () => {},
            onError: () => {},
        });
    }

    const columns: ColumnDef<ExtendedState>[] = React.useMemo(
        () => [
            {
                    ...
                    return (
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                                ...
                                <DropdownMenuSeparator />
                                <DropdownMenuItem onClick={() => onEditStateClicked(state)}>Edit</DropdownMenuItem>
                                <DropdownMenuItem className="text-red-600" onClick={() => deleteState(state.id)}>
                                    Delete
                                </DropdownMenuItem>
                            </DropdownMenuContent>
                        </DropdownMenu>
                            ...
                            <TableRow className="hover:bg-transparent data-[state=selected]:bg-transparent">
                                <TableCell colSpan={columns.length} className="h-48">
                                    <EmptyState
                                        ...
                                        description="Your states will show up here as soon as a state is created."
                                    />
                                </TableCell>
                            </TableRow>
                        )}
